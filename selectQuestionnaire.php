...
<head>
  ...
  <title>UoD Select Questionnaire</title>
</head>
  ...
  <div class="container">
    <div class="row">
      ...
      <div id="loginCol" class="col-md-4 col-xs-10">
        <h1>UoD Select Questionnaire</h1> <hr>
        <form action="/answerQuestionnaire.php" method="POST">
          ...
          <button id="submitBtn"type="submit" class="btn btn-primary" name ="submitBtn">Answer Questionnaire</button>
        </form>
      </div>
      <div class="col-md-4 col-xs-1">
